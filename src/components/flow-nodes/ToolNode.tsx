...
const ToolNode: React.FC<NodeProps> = ({ data, selected }) => {
  ...
  return (
    <motion.div
      className={`relative bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 border-2 rounded-2xl p-5 shadow-lg min-w-[140px] transition-all duration-300 ${
        selected 
          ? `border-2 shadow-xl` 
